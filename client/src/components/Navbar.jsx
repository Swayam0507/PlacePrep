    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <Link to={isAuthenticated ? "/dashboard" : "/"} className="navbar-logo">
          ...
          <span className="logo-text">PlacePrep</span>
        </Link>
            ...
            <>
              ...
              {isAdmin && (
                <div className="nav-admin-group">
                  ...
                  <Link to="/admin/questions" className={`nav-link admin-link ${isActive("/admin/questions") ? "active" : ""}`}>📝 Q&A</Link>
                  <Link to="/admin/users" className={`nav-link admin-link ${isActive("/admin/users") ? "active" : ""}`}>👥 Users</Link>
                </div>
              )}
            ...
            <>
              ...
              {isAdmin && (
                <>
                  ...
                  <p className="mobile-section-label">Admin Panel</p>
                  <Link to="/admin" className="mobile-nav-link admin" onClick={() => setMobileMenuOpen(false)}>📊 Analytics</Link>
                  <Link to="/admin/questions" className="mobile-nav-link admin" onClick={() => setMobileMenuOpen(false)}>📝 Manage Questions</Link>
                  <Link to="/admin/users" className="mobile-nav-link admin" onClick={() => setMobileMenuOpen(false)}>👥 Manage Users</Link>
                </>
              )}
